...
>
  ...
  {#if text}
  <text class="vehicle-text" fill="white" x="50%" y="45%" dominant-baseline="middle" text-anchor="middle">
    {text}
  </text>
  <text class="vehicle-text2" fill="white" x="50%" y="70%" dominant-baseline="middle" text-anchor="middle">
    {text2}
  </text>
  {/if}
  <g >
